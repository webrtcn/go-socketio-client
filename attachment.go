...
/*Attachment is an attachment handler used in emit args.
* All attachments will send as binary in transport layer. When use attachment,
* make sure use as pointer.*/
...
//UnmarshalJSON decoder from json
